...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "GoalCoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strMainNetDNSSeed[][2] = {
    {"goalcoin.co seed #1", "107.170.83.208"},
	{"goalcoin.co seed #1", "107.170.111.159"},
    {NULL, NULL}
};

static const char *strTestNetDNSSeed[][2] = {
    {"goalcoin.co testnet seed #1", "107.170.83.208"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. GoalCoin is probably already running."), addrBind.ToString().c_str());
        else
